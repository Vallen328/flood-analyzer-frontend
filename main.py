...
async def analyze_coordinates(request: CoordinateRequest):
    ...
    try:
        ...
        # Example: Create a prompt for Gemini
        prompt = f"""
        Analyze flood risk for coordinates:
        Latitude: {request.latitude}, Longitude: {request.longitude}.
        Consider terrain elevation, distance to nearest water body, and climate factors.
        
        Return data in JSON format with:
        - risk_level
        - description
